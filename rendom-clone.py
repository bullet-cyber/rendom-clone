...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mERROR-101')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\33[1;31m [ERROR-101-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
        ...
        sys.stdout.write(f'\r\r%s {x}[{xr}ERROR-101💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
